...
if("TRUE" STREQUAL "TRUE")
  set(zbar_ros_SOURCE_PREFIX /home/zhuyujin/ros/src/zbar_ros)
  set(zbar_ros_DEVEL_PREFIX /home/zhuyujin/ros/devel)
  set(zbar_ros_INSTALL_PREFIX "")
  set(zbar_ros_PREFIX ${zbar_ros_DEVEL_PREFIX})
else()
  set(zbar_ros_SOURCE_PREFIX "")
  set(zbar_ros_DEVEL_PREFIX "")
  set(zbar_ros_INSTALL_PREFIX /home/zhuyujin/ros/install)
...
if(NOT "/home/zhuyujin/ros/src/zbar_ros/include " STREQUAL " ")
  set(zbar_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/zhuyujin/ros/src/zbar_ros/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'zbar_ros' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Paul Bovbel <pbovbel@clearpathrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'zbar_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zhuyujin/ros/src/zbar_ros/${idir}'.  Ask the maintainer 'Paul Bovbel <pbovbel@clearpathrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zhuyujin/ros/devel/lib;/home/zhuyujin/ros/devel/lib;/opt/ros/indigo/lib)
