...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'zbar_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zhuyujin/ros/install/${idir}'.  Ask the maintainer 'Paul Bovbel <pbovbel@clearpathrobotics.com>' to fix it.")
    endif()
